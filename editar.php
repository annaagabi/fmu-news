...
<body>
  <header class="borda-vermelha border-2 border-top-0 border-end-0 border-start-0 mb-5">
    <div class="d-flex justify-content-between align-items-center m-5 mb-4 cabecalho">
      ...
      <a href="./index.html"><button class="botao-estilo botao-cadastro borda-raio fw-bold">SAIR</button></a>
    </div>
  </header>

  <main>
    <form action="#" method="post" class="d-flex align-items-center justify-content-center flex-column gap-main" id="nova-noticia">
      ...
      <div class="botoes d-flex align-items-center justify-content-center">
        ...
        <button type="button" id="noticia-modal" class="botao-estilo botao-cadastro borda-raio fw-bold">POSTAR</button>
      </div>
